...
- **项目源码**: [GitHub](https://github.com/Xposed-Modules-Repo/me.yun.fkwechat)
- **插件仓库**: [down.yunpro.club](https://down.yunpro.club)
- **开发文档**: [decs.yunpro.club](https://decs.yunpro.club)
- **Telegram**: [@FkWeChat](https://t.me/FkWeChat)
- **BeanShell**: [BeanShell](https://github.com/CopyLibs/BeanShell-Android)
